...
\newcommand{\versuch}{Properties of Cosmic Myons} %Versuch:
\newcommand{\nameeins}{Julius Aichert} %Name1 (Vor und Nachname):
\newcommand{\emaileins}{uhoeb@student.kit.edu} %E-Mail 1:
\newcommand{\namezwei}{Martin Achtner; Max Werner} %Name2 (Vor und Nachname):
\newcommand{\emailzwei}{} %E-Mail 2:

\newcommand{\assistent}{Tatiana Selezneva} %Assistent*in:
\newcommand{\durchfuehrungsdatum}{02.06.2025} %Durchgeführt am:
\newcommand{\abgabedatum}{30.06.2025} %Protokollabgabe am:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
