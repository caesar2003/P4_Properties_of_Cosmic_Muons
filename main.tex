...
\import{chapters/}{Exercises}%kann so dem Inhaltsverzeichnis hinzugefügt werden
%\includepdf[pages=1,pagecommand={}]{include/Aufgabenblatt.pdf} %
...
\newpage
\addcontentsline{toc}{chapter}{Measurement protocol}
